...
Dalsze porównywanie wariantów poprzedziło zmianę głównego logo strony. To archiwum propozycji, a nie informacja o wdrożeniu konkretnego znaku. Warianty PNG można ponownie edytować generatorem; szkice HTML/CSS są zapisane w formie źródłowej. Nie przygotowano jeszcze wektorowych plików SVG dla wygenerowanych znaków.
