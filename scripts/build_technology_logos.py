...
MOTIFS = {
    ...
    'ai-search': ('AI / LLM', '<g fill="none" stroke="#101b22" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"><circle cx="34" cy="32" r="25"/><path d="m53 51 21 22M23 22l23 4-14 19-9-23"/></g><circle cx="23" cy="22" r="6"/><circle cx="46" cy="26" r="6"/><circle cx="32" cy="45" r="6"/>'),
}
